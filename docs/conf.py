...
htmlhelp_basename = "enterprisedoc"
...
# [howto/manual]).
latex_documents = [
    ("index", "enterprise.tex", "enterprise Documentation", "Justin A. Ellis", "manual"),
]
...
man_pages = [("index", "enterprise", "enterprise Documentation", ["Justin A. Ellis"], 1)]
