...
from tests.enterprise_test_data import ON_GITHUB


@pytest.mark.skipif(ON_GITHUB, reason="Skipping tests that require dependencies not available on GitHub Actions.")
